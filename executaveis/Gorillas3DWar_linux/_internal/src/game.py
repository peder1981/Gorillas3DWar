...
class Game(Gorillas3DWar):
    """Classe para compatibilidade com código existente que importa Game.
    Esta classe herda todas as funcionalidades do Gorillas3DWar para manter
