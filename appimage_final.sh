#!/bin/bash
# Script para criar um AppImage do Gorillas 3D War com correções específicas

echo "=== Criando AppImage do Gorillas 3D War (Versão Final) ==="
...
# Agora, criamos o AppImage usando o script original, mas com o arquivo já corrigido
...
# Cria o AppImage
echo "Criando AppImage Final..."
$APPIMAGETOOL "$TRABALHO" "Gorillas3DWar-Final-x86_64.AppImage"

echo "AppImage criado: Gorillas3DWar-Final-x86_64.AppImage"
